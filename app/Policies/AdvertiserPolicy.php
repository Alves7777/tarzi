...
class AdvertiserPolicy
{
    ...
    public function view(AuthUser $authUser, Advertiser $advertiser): bool
    {
    ...
    public function update(AuthUser $authUser, Advertiser $advertiser): bool
    {
        return $authUser->can('Update:Advertiser');
    }

    public function delete(AuthUser $authUser, Advertiser $advertiser): bool
    {
    ...
    {
        return $authUser->can('DeleteAny:Advertiser');
    }

    public function restore(AuthUser $authUser, Advertiser $advertiser): bool
    {
        return $authUser->can('Restore:Advertiser');
    }

    public function forceDelete(AuthUser $authUser, Advertiser $advertiser): bool
    {
    ...
    public function replicate(AuthUser $authUser, Advertiser $advertiser): bool
    {
