        ...
        return $table
            ...
            ->headerActions([
                ...
                PrintTableAction::make()
                    ->title(static::getPluralModelLabel())
                    ->columns([
                        PrintColumn::make('name')
                            ->label(__('filament-shield::filament-shield.column.name'))
                            ->formatStateUsing(fn (mixed $state): string => Str::headline((string) $state)),
                        PrintColumn::make('guard_name')
                            ->label(__('filament-shield::filament-shield.column.guard_name')),
                        PrintColumn::make('permissions_count')
                            ->label(__('filament-shield::filament-shield.column.permissions')),
                        PrintColumn::make('updated_at')
                            ->label(__('filament-shield::filament-shield.column.updated_at')),
                    ]),
            ])
            ->recordActions([
